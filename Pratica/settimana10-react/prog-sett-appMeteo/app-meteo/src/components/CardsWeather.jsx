			...
			>
				...
				>
					...
					<div className="text-center p-sm-1 p-4 divInfoCard">
						...
						<p className="h3">{weatherData.fetchWeather.weather?.[0]?.description}</p>
					</div>
				</Card>
				<Card
					className=" ps-2 border border-0 rounded rounded-3 d-flex flex-row align-items-center text-white cardWeather"
				...
				>
					...
					<div className="text-center p-sm-3 p-4 divInfoCard">
						...
						<p className="h2">{weatherData.fetchWeather.clouds?.all}%</p>
					</div>
				</Card>
				<Card
					className="ps-2 border border-0 rounded rounded-3 d-flex flex-row align-items-center text-white cardWeather"
				...
				>
					...
					<div className="text-center p-sm-1 p-4 divInfoCard">
						...
						<p className="h2">{weatherData.fetchWeather.wind?.speed} km/h</p>
					</div>
				</Card>
				<Card
				...
				>
					...
					<div className="text-center p-sm-1 p-4 divInfoCard">
						...
						<p className="h2">{weatherData.fetchWeather.main?.humidity}%</p>
					</div>
				</Card>
			</Col>
    </>
