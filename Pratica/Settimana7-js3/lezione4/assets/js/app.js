    ...
    <div class="card mb-4 shadow-sm">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div class="btn-group">
            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="detailsPhoto('${element.id}')">
              View
            </button>
...
//Details Img
const detailsPhoto = (idPhoto) => {
	const urlFinale = url + idPhoto;
	fetch(urlFinale, {
		headers: {
			Authorization: key,
		},
		...
		.then((data) => {
			...
			const newPageview = `../../details-Img.html?id=${idPhoto}`;
			window.location.href = newPageview;
		});
};
